...
Codex and Claude Code do not share native conversation, model memory or automatically synchronized intent. Coordinate through maintained repository knowledge, explicit handoffs, Git evidence and human-mediated decisions.
...
4. Prepare bounded plans and implementation handoffs. State the objective, approved scope, exclusions, constraints, acceptance criteria, required verification and stopping conditions with detail proportional to the work.
