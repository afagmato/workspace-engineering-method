...
Claude Code does not share native conversation, model memory or automatically synchronized intent with Codex. Use maintained repository knowledge, explicit handoffs, Git evidence and human-mediated decisions.
...
2. Read the applicable canonical sources, Accepted ADRs and explicit implementation handoff.
...
8. Report changed files, verification results and remaining limitations for review.
